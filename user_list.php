...
<script>
	$(document).ready(function(){
		...
		dataModal("<i class='fa fa-id-card'></i> User Details","view_user.php?id="+$(this).attr('data-id'))
		})
		$('.delete_user').click(function(){
			confirmModal("Are you sure to delete this user?","delete_user",[$(this).attr('data-id')])
		})
